...
# /lib/assets
Rails.application.config.assets.precompile += %w( sb-admin-2.js sb-admin-2.css gentelella.js gentelella.css sidebar.css)

# vendor/assets
Rails.application.config.assets.precompile += %w( bootstrap-4.3.1.js bootstrap-4.3.1.css )